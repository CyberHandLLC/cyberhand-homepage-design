  ...
  return (
    <section className="flex flex-col lg:flex-row items-center space-y-8 lg:space-y-0 lg:space-x-12 w-full">
      <div className="w-full lg:w-1/2">
        ...
        <Button className="bg-white text-[#0f172a] hover:bg-white/90 font-medium rounded-md px-8 py-2">
          Learn More
        </Button>
      </div>
      
      <div className="w-full lg:w-1/2 bg-white/5 backdrop-blur-sm rounded-lg p-8 border border-white/10">
        <div className="relative aspect-square w-full max-w-md mx-auto">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="relative w-full h-full">
              ...
              <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-32 h-32 border-2 border-cyberhand-green rounded-full opacity-50"></div>
              <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-40 h-40 border border-cyberhand-green rounded-full opacity-30"></div>
            </div>
          </div>
        </div>
      </div>
